...
export default async function MembershipAccountPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f3ea] text-slate-900 flex flex-col font-sans">
      <SiteHeader />
      <section className="max-w-[1440px] mx-auto px-4 sm:px-8 py-10 border-b border-slate-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 w-full">
        <div>
