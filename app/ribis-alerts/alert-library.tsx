        ...
        {featured && (
          ...
          >
            <div className="flex items-center gap-2">
              <b className="text-md font-meduim text-[#c69b46]">Featured Alert</b>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-xs text-[#64748b] flex-wrap">
                <time className="font-meduim text-base text-[#102a43]">
                  {new Date(
              ...
              <h2 className="text-2xl sm:text-3xl font-serif font-semibold text-[#102a43] leading-tight">{featured.title}</h2>
              ...
              <small className="block text-[13px] text-[#94a3b8] font-meduim pt-1">
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between gap-2 pb-3 border-b border-[#f1f5f9]">
                  <div className="flex items-center gap-2">
                    <small className="text-base font-meduim text-[#64748b]">{x.category}</small>
                  </div>
                  <b className={`not-italic px-2 py-0.5 text-xs rounded-full border ${getSeverityStyle(x.severity)}`}>
                    {x.alert_status || x.severity}
                  </b>
                </div>
                <h3 className="text-xl font-serif font-semibold text-[#102a43] leading-snug">{x.title}</h3>
                <p className="text-base py-2 text-[#475569] leading-relaxed line-clamp-3">{x.summary}</p>
                <div className="text-[14px] text-[#94a3b8]">
                  Reviewed by <b className="font-meduim text-[#102a43]">{x.reviewed_by || 'Kav Haribis'}</b>
                  {x.updated_at && (
